-- Credits To @Kalu / @Kashnars For Doing this, I just took their wallet script and remade it https://forum.fivem.net/t/release-allcity-wallet-ccrp/145419 If you wan't me to remove it please pm me-->

TriggerEvent('ccrp:getSharedObject', function(obj) CCRP = obj end)

local function getMoneyFromUser(id_user)
	local xPlayer = CCRP.GetPlayerFromId(id_user)
...
AddEventHandler('allcity_wallet:getMoneys', function()
	...
	local xPlayer = CCRP.GetPlayerFromId(_source)
